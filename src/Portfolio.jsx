...
export default function Portfolio() {
  ...
  const evolutionBlocks = [
    ...
    { id: '2', title: 'UI/UX', icon: <Code2 size={18} />, desc: 'Frontend', x: 160, y: 50, bg: 'bg-[#0055FF]', text: 'text-white' }, // text-white ok di atas biru
    { id: '3', title: 'Scripts', icon: <Terminal size={18} />, desc: 'Python', x: 20, y: 130, bg: 'bg-[#FF007F]', text: 'text-white' }, // text-white ok di atas pink
  ...
  const projectsData = [
    {
      ...
      tags: [{ name: "Node.js", color: "bg-[#FFD700] text-black" }, { name: "Termux", color: "bg-[#0055FF] text-white" }]
    },
    {
      ...
      tags: [{ name: "AI Integration", color: "bg-[#FF007F] text-white" }, { name: "Prompt Eng.", color: "bg-black text-white" }]
    }
  ];
    ...
    <div className="relative min-h-screen bg-white bg-[radial-gradient(#d1d5db_2px,transparent_2px)] [background-size:32px_32px]">
      ...
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end">
        ...
        <motion.button 
          ...
          className={`w-14 h-14 md:w-16 md:h-16 brutal-box rounded-full border-4 border-black flex items-center justify-center shadow-[4px_4px_0_0_#111111] transition-colors ${isChatOpen ? 'bg-white text-black' : 'bg-[#0055FF] text-white'}`}
        >
        ...
        <section id="hero" className="min-h-[75vh] flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-12 mb-20 md:mb-32 relative z-10">
          ...
          >
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              href="#projects" 
              className="inline-flex items-center justify-center gap-3 brutal-btn px-6 md:px-8 py-3 md:py-4 font-black uppercase tracking-widest rounded-full cursor-pointer w-full md:w-auto text-sm md:text-base text-black bg-white border-2 border-black shadow-[4px_4px_0_0_#000000] hover:bg-[#FFD700]"
            >
              ...
              >
                <div className="w-full lg:w-1/3">
                  ...
                  <motion.a 
                    ...
                    className="inline-flex px-6 md:px-8 py-3 md:py-4 brutal-btn rounded-full text-xs md:text-sm font-black uppercase tracking-widest w-full md:w-auto justify-center text-black bg-white border-2 border-black shadow-[4px_4px_0_0_#000000] hover:bg-[#FFD700]"
                  >
                    Buka Halaman
                  </motion.a>
                </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mb-16 md:mb-24 px-4">
            ...
            >
              <motion.a 
                ...
                className="w-full md:w-auto inline-flex items-center justify-center gap-3 px-8 md:px-10 py-4 md:py-5 brutal-btn rounded-full text-sm md:text-lg font-black uppercase tracking-widest text-black bg-white border-2 border-black shadow-[4px_4px_0_0_#000000] hover:bg-[#FFD700]"
              >
                Order Jasa Sekarang
              </motion.a>
              <motion.a 
